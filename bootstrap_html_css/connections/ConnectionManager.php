...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "3984500_adota_at_fdb34.awardspace.net";
		$data["connName"] = "3984500_adota at fdb34.awardspace.net";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;fdb34.awardspace.net;mysql;;;3984500_adota;;1"; //currently unused

		$this->_connectionsIdByName["3984500_adota at fdb34.awardspace.net"] = "3984500_adota_at_fdb34.awardspace.net";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "3984500_adota";
		$data["ODBCPWD"] = "adotabd1234";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][0] = "fdb34.awardspace.net";
		$data["connInfo"][1] = "3984500_adota";
		$data["connInfo"][2] = "adotabd1234";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "3984500_adota";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=fdb34.awardspace.net;Uid=root;Pwd=adota1234;Database=3984500_adota;OPTION=3";
		// encription set
		...
		$connectionsData["3984500_adota_at_fdb34.awardspace.net"] = $data;

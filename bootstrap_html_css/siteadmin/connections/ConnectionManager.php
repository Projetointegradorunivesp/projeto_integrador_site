...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connectionString"] = "mysql;fdb34.awardspace.net;root;;;3984500_adota;;1"; //currently unused
		...
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=fdb34.awardspace.net;Uid=3984500_adota;Pwd=adotabd1234;Database=3984500_adota;OPTION=3";
		// encription set

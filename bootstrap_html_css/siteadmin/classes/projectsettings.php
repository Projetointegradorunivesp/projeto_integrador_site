...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "cachorro" ] = array( "url" => "cachorro", "type" => 0 );
	$projectEntitiesReverse[ "cachorro" ] = "cachorro";
	$projectEntities[ "gato" ] = array( "url" => "gato", "type" => 0 );
	$projectEntitiesReverse[ "gato" ] = "gato";
	$projectEntities[ "outro" ] = array( "url" => "outro", "type" => 0 );
	$projectEntitiesReverse[ "outro" ] = "outro";

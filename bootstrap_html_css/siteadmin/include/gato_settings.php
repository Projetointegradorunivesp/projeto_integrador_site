...
$tdatagato[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatagato[".originalPagesByType"] = $tdatagato[".pagesByType"];
$tdatagato[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatagato[".originalPages"] = $tdatagato[".pages"];
$tdatagato[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"list\":\"list\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="Portuguese(Brazil)")
{
	...
	$fieldLabelsgato["Portuguese(Brazil)"]["image_db"] = "Foto";
	...
	$pageTitlesgato["Portuguese(Brazil)"]["add"] = "Adicionar Novo Gato";
	$pageTitlesgato["Portuguese(Brazil)"]["edit"] = "[{%nomeg}]";
	$pageTitlesgato["Portuguese(Brazil)"]["view"] = "{%nomeg}";
	$pageTitlesgato["Portuguese(Brazil)"]["search"] = "Busca Avançada Gato";
...
$tdatagato[".isUseAjaxSuggest"] = true;
...
$tdatagato[".googleLikeFields"] = array();
$tdatagato[".googleLikeFields"][] = "idg";
$tdatagato[".googleLikeFields"][] = "nomeg";
$tdatagato[".googleLikeFields"][] = "racag";
$tdatagato[".googleLikeFields"][] = "sexog";
$tdatagato[".googleLikeFields"][] = "idadeg";
$tdatagato[".googleLikeFields"][] = "corg";
$tdatagato[".googleLikeFields"][] = "textog";
...
$tdatagato[".warnLeavingPages"] = true;
...
$tdatagato[".highlightSearchResults"] = true;

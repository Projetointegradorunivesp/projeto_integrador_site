...
$tdataoutro[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdataoutro[".originalPagesByType"] = $tdataoutro[".pagesByType"];
$tdataoutro[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdataoutro[".originalPages"] = $tdataoutro[".pages"];
$tdataoutro[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"list\":\"list\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="Portuguese(Brazil)")
{
	...
	$fieldLabelsoutro["Portuguese(Brazil)"]["image_db"] = "Foto";
	...
	$pageTitlesoutro["Portuguese(Brazil)"]["add"] = "Adicionar Novo Animal";
	$pageTitlesoutro["Portuguese(Brazil)"]["edit"] = "[{%nomeo}]";
	$pageTitlesoutro["Portuguese(Brazil)"]["view"] = "{%nomeo}";
	$pageTitlesoutro["Portuguese(Brazil)"]["search"] = "Busca Avançada Outros Animais";
...
$tdataoutro[".isUseAjaxSuggest"] = true;
...
$tdataoutro[".googleLikeFields"] = array();
$tdataoutro[".googleLikeFields"][] = "ido";
$tdataoutro[".googleLikeFields"][] = "nomeo";
$tdataoutro[".googleLikeFields"][] = "racao";
$tdataoutro[".googleLikeFields"][] = "sexoo";
$tdataoutro[".googleLikeFields"][] = "idadeo";
$tdataoutro[".googleLikeFields"][] = "coro";
$tdataoutro[".googleLikeFields"][] = "textoo";
...
$tdataoutro[".warnLeavingPages"] = true;
...
$tdataoutro[".highlightSearchResults"] = true;

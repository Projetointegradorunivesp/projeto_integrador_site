...
if(mlang_getcurrentlang()=="Portuguese(Brazil)")
{
	...
	$fieldLabelsusers["Portuguese(Brazil)"]["ext_security_id"] = "Ext Security Id";
	$fieldToolTipsusers["Portuguese(Brazil)"]["ext_security_id"] = "";
	$placeHoldersusers["Portuguese(Brazil)"]["ext_security_id"] = "";
...
$tdatausers[".connId"] = "3984500_adota_at_fdb34.awardspace.net";
...
$tdatausers[".sqlHead"] = "SELECT ID,  	username,  	password,  	email,  	fullname,  	groupid,  	active,  	ext_security_id";

...
class tDAL
{
	var $tbl3984500_adota_at_fdb34.awardspace.net__cachorro;
	var $tbl3984500_adota_at_fdb34.awardspace.net__gato;
	var $tbl3984500_adota_at_fdb34.awardspace.net__outro;
	var $tbl3984500_adota_at_fdb34.awardspace.net__users;
	var $tbl3984500_adota_at_fdb34.awardspace.net__usuarios;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "cachorro", "varname" => "3984500_adota_at_fdb34.awardspace.net__cachorro", "altvarname" => "cachorro", "connId" => "3984500_adota_at_fdb34.awardspace.net", "schema" => "", "connName" => "3984500_adota at fdb34.awardspace.net");
		$this->lstTables[] = array("name" => "gato", "varname" => "3984500_adota_at_fdb34.awardspace.net__gato", "altvarname" => "gato", "connId" => "3984500_adota_at_fdb34.awardspace.net", "schema" => "", "connName" => "3984500_adota at fdb34.awardspace.net");
		$this->lstTables[] = array("name" => "outro", "varname" => "3984500_adota_at_fdb34.awardspace.net__outro", "altvarname" => "outro", "connId" => "3984500_adota_at_fdb34.awardspace.net", "schema" => "", "connName" => "3984500_adota at fdb34.awardspace.net");
		$this->lstTables[] = array("name" => "users", "varname" => "3984500_adota_at_fdb34.awardspace.net__users", "altvarname" => "users", "connId" => "3984500_adota_at_fdb34.awardspace.net", "schema" => "", "connName" => "3984500_adota at fdb34.awardspace.net");
		$this->lstTables[] = array("name" => "usuarios", "varname" => "3984500_adota_at_fdb34.awardspace.net__usuarios", "altvarname" => "usuarios", "connId" => "3984500_adota_at_fdb34.awardspace.net", "schema" => "", "connName" => "3984500_adota at fdb34.awardspace.net");
	}

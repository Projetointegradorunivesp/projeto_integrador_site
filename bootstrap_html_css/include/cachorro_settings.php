...
$tdatacachorro[".pagesByType"] = my_json_decode( "{\"list\":[\"Lista\"],\"view\":[\"Detalhes\"]}" );
$tdatacachorro[".originalPagesByType"] = $tdatacachorro[".pagesByType"];
$tdatacachorro[".pages"] = types2pages( my_json_decode( "{\"list\":[\"Lista\"],\"view\":[\"Detalhes\"]}" ) );
$tdatacachorro[".originalPages"] = $tdatacachorro[".pages"];
$tdatacachorro[".defaultPages"] = my_json_decode( "{\"list\":\"Lista\",\"view\":\"Detalhes\"}" );
...
if(mlang_getcurrentlang()=="Portuguese(Brazil)")
{
	...
	$fieldLabelscachorro["Portuguese(Brazil)"]["image_db"] = "";
	...
	$pageTitlescachorro["Portuguese(Brazil)"]["Detalhes"] = "{%nomec}";
...
$tdatacachorro[".badgeColor"] = "DC143C";

...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "3984500_adota_at_fdb34.awardspace.net" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "cachorro", "varname" => "3984500_adota_at_fdb34.awardspace.net__cachorro", "altvarname" => "cachorro", "connId" => "3984500_adota_at_fdb34.awardspace.net", "schema" => "", "connName" => "3984500_adota at fdb34.awardspace.net");
			$dalTables[$conn->connId][] = array("name" => "gato", "varname" => "3984500_adota_at_fdb34.awardspace.net__gato", "altvarname" => "gato", "connId" => "3984500_adota_at_fdb34.awardspace.net", "schema" => "", "connName" => "3984500_adota at fdb34.awardspace.net");
			$dalTables[$conn->connId][] = array("name" => "outro", "varname" => "3984500_adota_at_fdb34.awardspace.net__outro", "altvarname" => "outro", "connId" => "3984500_adota_at_fdb34.awardspace.net", "schema" => "", "connName" => "3984500_adota at fdb34.awardspace.net");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "3984500_adota_at_fdb34.awardspace.net__users", "altvarname" => "users", "connId" => "3984500_adota_at_fdb34.awardspace.net", "schema" => "", "connName" => "3984500_adota at fdb34.awardspace.net");
			$dalTables[$conn->connId][] = array("name" => "usuarios", "varname" => "3984500_adota_at_fdb34.awardspace.net__usuarios", "altvarname" => "usuarios", "connId" => "3984500_adota_at_fdb34.awardspace.net", "schema" => "", "connName" => "3984500_adota at fdb34.awardspace.net");
		}
	}

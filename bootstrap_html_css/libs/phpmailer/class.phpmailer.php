...
class PHPMailer
{
     ...
     * @var string
     */
    public $From = 'root@fdb34.awardspace.net';
     ...
     * 'fdb34.awardspace.net.localdomain'.
     * @var string
     */
    public $Hostname = '';
     ...
     * @var string
     */
    public $Host = 'fdb34.awardspace.net';
     ...
     * Returns 'fdb34.awardspace.net.localdomain' if unknown.
     * @access protected
     * @return string
     */
    protected function serverHostname()
    {
        $result = 'fdb34.awardspace.net.localdomain';
